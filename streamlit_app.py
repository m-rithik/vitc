...
@st.cache_data(ttl=300)  # Cache the teacher data, refreshing every 5 minutes
...
@st.cache_data(ttl=300)  # Cache reviews data separately to prevent repeated API calls, refreshing every 5 minutes
def get_all_reviews():
